...
export default function TransactionStatus({}) {
  ...
  //To prevent closuing of the dialog
      ...
      >
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
           ...
           */}
            ...
            >
                <div className="status inlinr-block align-bottom py-6 bg-white border rounded-lg text-center overflow-hidden shadow-xl transform transiton-all md:w-[35%] sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">

...
contract CustomDex {
    ...
    //This mapping acts like a dictionary, associating string token names with their corresponding ERC20 token instances.
    ...
    //This mapping acts like a database, storing transaction history entries with unique uint256 identifiers.
    uint256 public _historyIndex;
    mapping(uint256 => History) private historys;

    //Token Creation:The constructor iterates through the tokens array, which contains names of supported tokens.
    constructor() {
